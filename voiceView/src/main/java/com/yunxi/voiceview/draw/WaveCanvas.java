package com.yunxi.voiceview.draw;
...
public class WaveCanvas {
    ...
    private   void init(){
        ...
        circlePaint.setColor(Color.parseColor(WaveAttrs.Color.LINE_TIME_COLOR));//设置上圆的颜色

        center = new Paint();//中心线
        center.setColor(Color.parseColor(WaveAttrs.Color.LINE_COLOR));// 画笔为color
        ...
        mwavePaint.setColor( Color.parseColor(WaveAttrs.Color.WAVE_COLOR));// 画笔为color
        mwavePaint.setStrokeWidth(1);// 设置画笔粗细
