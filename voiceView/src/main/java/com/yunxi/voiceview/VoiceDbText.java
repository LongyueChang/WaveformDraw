 ...
 */
public class VoiceDbText extends View {
    private final String TAG = VoiceDbText.class.getSimpleName();
     ...
     * 刻度按照屏幕宽等额分配分数
     */
    private final int dbDivision=61;


    public VoiceDbText(Context context) {
        this(context, null);
    }

    public VoiceDbText(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VoiceDbText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
